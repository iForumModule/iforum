<?php
// makepdf_class.php,v1.1 2004/03/12 (c)by St@neCold
// -------------------------------------------------
// For XOOPS2 - PHP Content Management System
// (or other's like phpNuke...it's your choice)
//
// based on:
...
//
// ..with some changes by me. Thx to Clément!


require XOOPS_ROOT_PATH.'/modules/newbb/include/fpdf.php';
...
//date+time
$printpdfdate = date($xdformat);
$printpdfhour = date($xtformat);
//Position and Font
$this->SetXY(25,-35);
$this->SetTextColor(0,0,255);
$this->SetFont('Arial','UI',8);
//Link+Page number
$this->Cell(0,10,$xurl,'T',0,'L',0,$xurl);
$pn=$this->PageNo();
$out=$printpdfdate;
$out.=' / ';
$out.=$printpdfhour;
...
$this->Cell(0,10,$out,'T',0,'R',0,$xmail);
}
}
?>
