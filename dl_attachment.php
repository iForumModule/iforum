...
$file_saved = ICMS_ROOT_PATH.'/'.$xoopsModuleConfig['dir_attachments'].'/'.$attach['name_saved'];
...
header("location: ".ICMS_URL.'/'.$xoopsModuleConfig['dir_attachments'].'/'.$attach['name_saved']);
