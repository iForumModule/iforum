...
switch ($op)
{
	...
	echo "
		...
		<td class='even' align='left'><a href='".XOOPS_URL."/modules/".basename( dirname( dirname( __FILE__ ) ) )."/viewtopic.php?topic_id=".$topic_id."' target='topic'>".$myts->htmlSpecialChars($down_array['topic_title'])."</a></td>\n
