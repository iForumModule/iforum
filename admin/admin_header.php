...
include_once ICMS_ROOT_PATH."/modules/".$xoopsModule->getVar("dirname")."/class/art/functions.admin.php";


// include the default language file for the admin interface
if ( !@include_once(ICMS_ROOT_PATH."/modules/".$xoopsModule->getVar("dirname")."/language/" . $xoopsConfig['language'] . "/main.php")){
