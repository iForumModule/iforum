...
CREATE TABLE `bb_categories` (
  ...
  `cat_state` tinyint(1) NOT NULL default '0',
  `cat_url` varchar(50) NOT NULL default '',
  `cat_showdescript` tinyint(1) NOT NULL default '0',
  PRIMARY KEY  (`cat_id`),
...
CREATE TABLE `bb_forums` (
  ...
  `forum_desc` text,
  `parent_forum` smallint(4) NOT NULL default '0',
  ...
  `forum_type` tinyint(1) NOT NULL default '0',
  `allow_html` tinyint(1) NOT NULL default '1',
  `allow_sig` tinyint(1) NOT NULL default '1',
  `allow_subject_prefix` tinyint(1) NOT NULL default '0',
  `hot_threshold` tinyint(3) unsigned NOT NULL default '10',
  `forum_order` smallint(4) NOT NULL default '0',
  `allow_attachments` tinyint(1) NOT NULL default '1',
  `attach_maxkb` smallint(3) NOT NULL default '1000',
  `attach_ext` text NOT NULL,
  `allow_polls` tinyint(1) NOT NULL default '0',
  `subforum_count` smallint(3) unsigned NOT NULL default '0',
  PRIMARY KEY  (`forum_id`),
  KEY `cat_forum` (`cat_id`, `forum_order`),
  KEY `forum_order` (`forum_order`, `forum_id`)
) TYPE=MyISAM;
...
CREATE TABLE `bb_votedata` (
  ...
  `ratinguser` int(10) NOT NULL default '0',
...
CREATE TABLE `bb_online` (
  ...
  `online_uid` int(10) NOT NULL default '0',
...
CREATE TABLE `bb_report` (
  ...
  `post_id` int(10) NOT NULL default '0',
  `reporter_uid` int(10) NOT NULL default '0',
...
CREATE TABLE `bb_posts` (
  ...
  FULLTEXT KEY `search_subject` (`subject`)
) TYPE=MyISAM;
...
CREATE TABLE `bb_posts_text` (
  ...
  `post_edit` text,
  PRIMARY KEY  (`post_id`),
  FULLTEXT KEY `search_text` (`post_text`)
) TYPE=MyISAM;
