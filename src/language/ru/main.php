<?php
	...
	define('_MD_URRECEIVING', 'Вы получили этот email, потому, что на собщение,отправленное Вами на форуме %s пришел отклик.'); // %s is your site name
	...
	define("_MD_THANKYOU", "Спасибо, что нашли время, чтобы проголосовать здесь, на %s"); // %s is your site name
	...
	define('_MD_USERSTAT', 'Статистика Форума пользователей');
	define('_MD_LEVEL_MOD_LEVEL', ' Уровень активности: Этот уровень определяется числом ваших собственных сообщений. Для расчета определенного уровня была использована хорошая математическая формула.');
	define("_MD_LEVEL_MOD_EXP", "Опыт: Эта панель показывает, как далеко вы находитесь далеко от следующего уровня пользователя. Как только этот бар достигнет 100%, ваше следующее сообщение обновит вас до следующего уровня пользователя. ");
	define("_MD_LEVEL_MOD_HP", "Деятельности: Это значение идет вверх или вниз в зависимости от вашей деятельности в сообществе. Упрощенное значение каждого пользователя ориентировано на определенное количество сообщений в день.");
	define("_MD_LEVEL_MOD_MP", "Время ожидания ответов: Этот бар показывает постоянство вашей деятельности, так как вы зарегистрированы, и т.е. как быстро вы ответили на статьи. Высокое значение означает, что вы реагируете редко или очень, очень медленно на статью");
?>