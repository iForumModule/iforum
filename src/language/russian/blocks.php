<?php
	...
	define($constpref."_RPLS", "Ответы");
	define($constpref."_VIEWS", "Просмотры");
	define($constpref."_LPOST", "Последнее сообщение");
	define($constpref."_VSTFRMS", "Форумы");
	define($constpref."_DISPLAY", "Number of posts: ");
	define($constpref."_DISPLAYMODE", "Режим отображения: ");
	...
	define($constpref."_TITLE", "Заголовок");
	define($constpref."_AUTHOR", "Автор");
