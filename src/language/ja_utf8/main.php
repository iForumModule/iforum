<?php
	// $Id: main.php 24794 2012-12-24 06:31:18Z sato-san $
	...
	define('_MD_GO', 'Go');
	define('_MD_SELFORUM', 'フォーラムを選択');
	 
	define('_MD_THIS_FILE_WAS_ATTACHED_TO_THIS_POST', '添付ファイル:');
	define('_MD_ALLOWED_EXTENSIONS', '許可された拡張子');
	define('_MD_MAX_FILESIZE', '最大ファイル·サイズ');
	define('_MD_ATTACHMENT', 'ファイルを添付する');
	define('_MD_FILESIZE', 'サイズ');
	define('_MD_HITS', 'ヒット数');
	define('_MD_GROUPS', 'グループ:');
	define('_MD_DEL_ONE', 'Delete only this post');
	define('_MD_DEL_RELATED', 'Delete all posts in this topic');
	define('_MD_MARK_ALL_FORUMS', '全フォーラムをマークする');
	define('_MD_MARK_ALL_TOPICS', 'すべてのトピックをマーク');
	define('_MD_MARK_UNREAD', '(読まれていない)');
	define('_MD_MARK_READ', '(読む)');
	...
	define('_MD_TOPICS', 'トピック');
	define('_MD_POSTS', '投稿');
	define('_MD_LASTPOST', '最後の投稿');
	...
	define('_MD_POSTER', '投稿投稿者');
	define('_MD_VIEWS', '閲覧数');
	...
	define('_MD_TOPIC_SUBJECTC', 'トピックのプレフィックス:');
	 
	 
	define('_MD_RATINGS', '評価');
	...
	define('_MD_USERWROTE', '%s 書いた:'); // %s is username
	define('_MD_RE', 'Re');
	...
	define('_MD_SUBJECTC', 'タイトル:');
	define('_MD_MESSAGEICON', '本文アイコン:');
	define('_MD_MESSAGEC', '本文:');
	define('_MD_ALLOWEDHTML', '使用できるHTML:');
	define('_MD_OPTIONS', 'オプション:');
	define('_MD_POSTANONLY', 'Post Anonymously');
	define('_MD_DOSMILEY', 'スマイリーを有効にする');
	define('_MD_DOXCODE', 'BBコードを有効にする');
	define('_MD_DOBR', 'Enable line break (Suggest to turn off if HTML enabled)');
	define('_MD_DOHTML', 'HTMLタグを有効にする');
	define('_MD_NEWPOSTNOTIFY', 'このスレッドに新しい投稿を知らせて');
	define('_MD_ATTACHSIG', '署名を添付');
	define('_MD_POST', 'Post');
	define('_MD_SUBMIT', '提出する');
	define('_MD_CANCELPOST', '投稿キャンセル');
	define('_MD_REMOVE', '削除する');
	...
	// online.php
	define('_MD_USERS_ONLINE', 'オンラインのユーザ:');
	define('_MD_ANONYMOUS_USERS', '匿名ユーザー');
	define('_MD_REGISTERED_USERS', '登録ユーザー: ');
	define('_MD_BROWSING_FORUM', 'ユーザーはフォーラムを閲覧');
	define('_MD_TOTAL_ONLINE', '合計 %d ユーザーオンライン。');
	define('_MD_ADMINISTRATOR', '管理者');
