...
{
	global $db, $myts, $forumTable, $forumImage;
...
{
	global $db, $myts, $forumTable, $forumImage, $meta;
	...
	echo "<i><strong>".$meta['copyright']."<br /><a href=".ICMS_URL.">".ICMS_URL."</a>
		...
		<a href='".ICMS_URL."/modules/".icms::$module->getVar("dirname")."/viewtopic.php?topic_id=$topic_id&amp;forum=$forum'>".ICMS_URL."/modules/".icms::$module->getVar("dirname")."/viewtopic.php?topic_id=$topic_id&amp;forum=$forum</a>
		</strong></i><br /><br />";
	// ============= END LINK HEADER =============
