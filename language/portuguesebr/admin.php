...
define("_AM_NEWBB_PENDING_POSTS_FOR_AUTH","Mensagens pendentes de aprovação");
...
define("_AM_NEWBB_FORUMCREATED","Operação de inclusão realizada com sucesso.");
define("_AM_NEWBB_ACCESSLEVEL","Nível de acesso:");
define("_AM_NEWBB_CATEGORY1","Categoria");
define("_AM_NEWBB_FORUMUPDATE","Operação de atualização realizada com sucesso!");
...
define("_AM_NEWBB_CAT_ACCESS","Quem acessará as categorias?");
define("_AM_NEWBB_CAN_ACCESS","Quem acessará os fóruns?");
define("_AM_NEWBB_CAN_VIEW","Quem lerá os tópicos?");
define("_AM_NEWBB_CAN_POST","Quem iniciará tópicos?");
define("_AM_NEWBB_CAN_REPLY","Quem responderá os tópicos?");
define("_AM_NEWBB_CAN_EDIT","Quem editará os tópicos?");
define("_AM_NEWBB_CAN_DELETE","Quem excluirá os tópicos");
define("_AM_NEWBB_CAN_ADDPOLL","Quem incluirá enquetes?");
define("_AM_NEWBB_CAN_VOTE","Quem poderá votar?");
define("_AM_NEWBB_CAN_ATTACH","Quem anexará arquivos?");
define("_AM_NEWBB_CAN_NOAPPROVE","Quem enviará sem aprovação?");
define("_AM_NEWBB_ACTION","Ação");

define("_AM_NEWBB_PERM_TEMPLATE","Modelos de Permissão");
