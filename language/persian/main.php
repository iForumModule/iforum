<?php
	...
	define('_MD_ALLPOSTS', 'همه‌ی پیام‌ها');
	...
	define('_MD_ERRORCONNECT', 'خطا: تماس با پایگاه داده‌ی انجمن مقدور نیست.');
	define('_MD_ERROREXIST', 'خطا: انجمنی که شما انتخاب کرده‌اید وجود ندارد.');
	define('_MD_ERROROCCURED', 'یک خطا رخ داده‌است.');
	define('_MD_COULDNOTQUERY', 'در پایگاه داده‌ی انجمن نمی‌توان استفسار کرد.');
	...
	// polls.php
	define("_MD_POLL_DBUPDATED", "پایگاه داده‌ها با موفقیت به روز شد!");
	...
	//viewpost.php
	define("_MD_VIEWALLPOSTS", "همه‌ی پیام‌ها");
	...
	define("_MD_SPLIT_ALL", "همه‌ی را جدا کن");
