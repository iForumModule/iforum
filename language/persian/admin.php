...
define('_AM_NEWBB_MESSAGEICON','شکلکپیام:');
...
define('_AM_NEWBB_POLLMODULE','ماژول Xoops poll');
...
define("_AM_NEWBB_TWDAFAP","این قسمت انجمن و تمام پیام‌های زده شده در آن را حذف خواهد کرد.<br><br>هشدار: آیا مطمئنید که این انجمن را می‌خواهید پاککنید؟");
define("_AM_NEWBB_FORUMREMOVED","انجمن‌ پاکشد.");
define("_AM_NEWBB_CREATENEWFORUM","ایجاد یکانجمن جدید");
...
define("_AM_NEWBB_WAYSYWTDTTAL","این قسمت انجمن‌های زیر شاخه را پاکنخواهد کرد.<br><br>WARNINGبرای پاککردن آن از ویرایش انجمن‌اقدام کنید. آیا مایلید شاخه‌را پاککنید؟");
...
define("_AM_NEWBB_MSG_ERR_FORUM_MOVED","ناتوانی در بردن انجمن.");
...
define("_AM_NEWBB_SETFORUMORDER","تغییر محل قرار گیری انجمن در شاخه");
define("_AM_NEWBB_BOARDREORDER","مکان انجمن تغییر داده شد");

// admin_permission.php
define("_AM_NEWBB_PERMISSIONS_TO_THIS_FORUM","دسترسی تاپیکها برای این انجمن");
...
define('_AM_NEWBB_MODULE_BUG', "گزارش دادن یک باگ برای این ماژول");
