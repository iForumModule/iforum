...
//%%%%%%	File Name  index.php   	%%%%%
define("_AM_NEWBB_FORUMCONF","Настройки форума");
define("_AM_NEWBB_ADDAFORUM","Добавить форум");
define("_AM_NEWBB_SYNCFORUM","Синхронизация форумов");
...
define("_AM_NEWBB_GENERALSET", "Установки модуля" );
...
define("_AM_NEWBB_PENDING_POSTS_FOR_AUTH","Ожидание авторизации сообщения");
...
define("_AM_NEWBB_SHORTSUMMARY","Резюме форума");
...
define('_AM_NEWBB_PREFERENCES','Свойства модуля');
define('_AM_NEWBB_POLLMODULE','Xoops Poll Module');
define('_AM_NEWBB_POLL_OK','Готов к использованию');
define('_AM_NEWBB_GDLIB1','Библиотека GD1:');
define('_AM_NEWBB_GDLIB2','Библиотека GD2:');
define('_AM_NEWBB_AUTODETECTED','Автоопределение: ');
define('_AM_NEWBB_AVAILABLE','Доступен');
define('_AM_NEWBB_NOTAVAILABLE','<font color="red">Недоступно</font>');
define('_AM_NEWBB_NOTWRITABLE','<font color="red">Только чтение</font>');
define('_AM_NEWBB_IMAGEMAGICK','ImageMagicK:');
define('_AM_NEWBB_IMAGEMAGICK_NOTSET','Не установлено');
...
define("_AM_NEWBB_CREATENEWCATEGORY","Создание новой категории");
...
define("_AM_NEWBB_SETFORUMORDER","Упорядочивание форумов");
...
define('_AM_NEWBB_MODULE_DEMO', "Дкмо сайт");
...
define("_AM_NEWBB_DIGESTCONTENT","Контент дайджеста");

// admin_votedata.php
define("_AM_NEWBB_VOTE_RATINGINFOMATION", "Информация о голосовании");
...
define("_AM_NEWBB_VOTE_USERAVG", "Средняя оценка");
define("_AM_NEWBB_VOTE_TOTALRATE", "Всего оценено");
define("_AM_NEWBB_VOTE_DATE", "Размещено");
define("_AM_NEWBB_VOTE_RATING", "Оценка");
define("_AM_NEWBB_VOTE_NOREGVOTES", "No Registered User Votes");
define("_AM_NEWBB_VOTE_NOUNREGVOTES", "No Unregistered User Votes");
define("_AM_NEWBB_VOTEDELETED", "Данные о голосовании удалены.");
define("_AM_NEWBB_VOTE_ID", "ID");
define("_AM_NEWBB_VOTE_FILETITLE", "Заголовок потока");
define("_AM_NEWBB_VOTE_DISPLAYVOTES", "Информация о голосовании");
