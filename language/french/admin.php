...
define ("_AM_NEWBB_BOARDSUMMARY", "Statistiques du forum");
...
define ("_AM_NEWBB_SHORTSUMMARY", "Sommaire du forum");
...
define('_AM_NEWBB_DIRNOTCREATED','Le r&eacute;pertoire ne peut pas &ecirc;tre cr&eacute;&eacute;');
...
define ("_AM_NEWBB_WAYSYWTDTTAL", "Note : Ceci ne supprimera pas les forums situ&eacute;s sous la cat&eacute;gorie, pour ce faire vous devez utiliser la section Editer un forum.<br /><br />AVERTISSEMENT : Etes vous certain de vouloir effacer cette cat&eacute;gorie ?");
...
define ("_AM_NEWBB_DATABASEERROR", "Erreur dans la base de donn&eacute;es");
...
define ("_AM_NEWBB_MAKE_SUBFORUM_OF", "Cr&eacute;er un sous-forum de :");
...
define("_AM_NEWBB_CAT_ACCESS","Acc&egrave;s aux cat&eacute;gories");
define("_AM_NEWBB_CAN_ACCESS","Peut acc&eacute;der");
...
define("_AM_NEWBB_PERM_TEMPLATE","Mod&egrave;le de Permissions");
define("_AM_NEWBB_PERM_TEMPLATE_DESC","Sera appliqu&eacute; aux nouveaux forums");
define("_AM_NEWBB_PERM_FORUMS","S&eacute;lectionnez les forums");
define("_AM_NEWBB_PERM_TEMPLATE_CREATED","Le mod&egrave;le de permissions a &eacute;t&eacute g&eacute;n&eacute;r&eacute;");
define("_AM_NEWBB_PERM_TEMPLATE_ERROR","Une erreur s'est produite durant la cr&eacute;ation du mod&egrave;le de permission");
define("_AM_NEWBB_PERM_TEMPLATEAPP","Appliquer les permissions par d&eacute;faut");
define("_AM_NEWBB_PERM_TEMPLATE_APPLIED","Les permissions par d&eacute;faut ont &eacute;t&eacute; appliqu&eacute;es aux forums");
define("_AM_NEWBB_PERM_ACTION","Outils de Gestion des Permissions");
define("_AM_NEWBB_PERM_SETBYGROUP","D&eacute;duire les permissions des droits des groupes");
