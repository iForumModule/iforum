<?php
	...
	define($constpref."_EDIT", "Modificar");
	...
	define($constpref."_FORUMREMOVED", "El foro y todos sus mensajes han sido eliminados.");
	define($constpref."_CREATENEWFORUM", "Crear un nuevo foro");
	define($constpref."_EDITTHISFORUM", "Modificar un foro:");
	define($constpref."_SET_FORUMORDER", "Ajustar orden del foro:");
	define($constpref."_ALLOWPOLLS", "Permitir encuestas:");
	define($constpref."_ATTACHMENT_SIZE" , "Tamaño máx. en kb:");
	...
	define($constpref."_HOTTOPICTHRESHOLD", "Cuantos mensajes candentes mostrar (Hot Topic Threshold):");
	...
	define($constpref."_DATABASEERROR", "Error de la base de datos");
	define($constpref."_CATEGORYUPDATED", "Categoría actualizada.");
	define($constpref."_EDITCATEGORY", "Modificar categoría:");
	define($constpref."_CATEGORYTITLE", "Título:");
	...
	define($constpref."_FORUM_ERROR", "Error en la configuración del foro.");
	...
	define($constpref."_CAN_EDIT", "Pueden modificar");
	...
	define($constpref."_VOTE_FILETITLE", "Título del tema");
