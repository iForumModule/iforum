...
define("_MI_RSS_MAX_DESCRIPTION", "Longitud Max. de la descripción");
...
define("_MI_MENUMODE","Modo por defecto del menú");
define("_MI_MENUMODE_DESC","'SELECT' - Opciones de selección<br />'HOVER' - Funciona lento con IE<br />'CLICK' - Requiere JAVASCRIPT");
...
define("_MI_QUICKREPLY_ENABLE_DESC", "Activará un formulario de respuesta rápida en el hilo mediante un botón.");
...
define ('_MI_NEWBB_GLOBAL_NEWPOST_NOTIFY', 'Nuevo envío');
define ('_MI_NEWBB_GLOBAL_NEWPOST_NOTIFYCAP', 'Notificarme de cualquier nuevo envío.');
define ('_MI_NEWBB_GLOBAL_NEWPOST_NOTIFYDSC', 'Recibir notificación cuando cualquier nuevo mensaje es enviado.');
define ('_MI_NEWBB_GLOBAL_NEWPOST_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notificación : Nuevo envío');

define ('_MI_NEWBB_FORUM_NEWPOST_NOTIFY', 'Nuevo envío');
define ('_MI_NEWBB_FORUM_NEWPOST_NOTIFYCAP', 'Notificarme de cualquier nuevo envío en el foro actual.');
define ('_MI_NEWBB_FORUM_NEWPOST_NOTIFYDSC', 'Recibir notificación cuando cualquier nuevo mensaje es enviado en el foro actual.');
define ('_MI_NEWBB_FORUM_NEWPOST_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notificación : Nuevo envío en foro');

define ('_MI_NEWBB_GLOBAL_NEWFULLPOST_NOTIFY', 'Nuevo envío (Texto completo)');
define ('_MI_NEWBB_GLOBAL_NEWFULLPOST_NOTIFYCAP', 'Notificarme de cualquier nuevo envío (incluir el texto del mensaje).');
define ('_MI_NEWBB_GLOBAL_NEWFULLPOST_NOTIFYDSC', 'Recibir notificación con texto completo cuando cualquier nuevo mensaje es enviado.');
define ('_MI_NEWBB_GLOBAL_NEWFULLPOST_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notificación : Nuevo envío (texto completo)');

define ('_MI_NEWBB_GLOBAL_DIGEST_NOTIFY', 'Selección');
define ('_MI_NEWBB_GLOBAL_DIGEST_NOTIFYCAP', 'Notificarme de cualquier nueva selección.');
define ('_MI_NEWBB_GLOBAL_DIGEST_NOTIFYDSC', 'Recibir notificación de selección.');
...
define($constpref."_INSTALL_POST_TEXT", "
	...
	Si tiene cualquier pregunta referente al uso de CBB, por favor, visite su sitio de soporte local, o la página del [url=http://community.impresscms.org/modules/newbb/viewforum.php?forum=9]Módulo CBB[/url]
	");
?>