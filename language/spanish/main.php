...
define('_MD_MAX_FILESIZE','Tama�o m�ximo del archivo');
define('_MD_ATTACHMENT','Archivo adjunto');
define('_MD_FILESIZE','Tama�o');
define('_MD_HITS','Clics');
define('_MD_GROUPS','Grupos:');
define('_MD_DEL_ONE','Eliminar s�lo este mensaje');
...
define('_MD_MARK_UNREAD','no le�dos');
...
define('_MD_LASTVISIT','Su �ltima Visita: %s');
define('_MD_ADVSEARCH','B�squeda Avanzada');
...
define("_MD_PENDING_POSTS_FOR_AUTH","Mensajes pendientes de aprobaci�n:");
...
//define('_MD_SEARCHRESULTS','Resultado de la b�squeda');
define('_MD_FORUMINDEX','%s �ndice del foro');
...
define('_MD_NEXTPAGE','P�gina siguiente');
define('_MD_SORTEDBY','Ordenar por');
define('_MD_TOPICTITLE','T�tulo del tema');
define('_MD_NUMBERREPLIES','N�mero de respuestas');
define('_MD_TOPICPOSTER','Enviado por');
define('_MD_TOPICTIME','Fecha de publicaci�n');
define('_MD_LASTPOSTTIME','Hora del �ltimo env�o');
define('_MD_ASCENDING','Orden ascendente');
define('_MD_DESCENDING','Orden descendente');
define('_MD_FROMLASTHOURS','Desde las %s �ltimas horas');
define('_MD_FROMLASTDAYS','Desde los %s �ltimos d�as');
define('_MD_THELASTYEAR','Desde el a�o pasado');
...
define("_MD_CAN_NOAPPROVE", "<b>Puede</b> hacer un env�o sin aprobaci�n.<br />");
define("_MD_CANNOT_NOAPPROVE", "<b>No puede</b> hacer un env�o sin aprobaci�n.<br />");
...
define('_MD_DIGESTTOPIC','Incluir este tema en la selecci�n');
define('_MD_UNDIGESTTOPIC','Excluir este tema de la selecci�n');
...
define('_MD_QUICKREPLY','respuesta r�pida');
define('_MD_POSTREPLY','Env�e su respuesta');
...
define('_MD_ICQ','ICQ');
define('_MD_PRINT_TOPIC_LINK', 'URL de esta discusi�n');
...
define('_MD_KARMA_REQUIREMENT', 'Su karma personal %s no es el karma requerido %s. <br /> Por favor int�ntelo m�s adelante.');
...
define('_MD_QUICKREPLY_EMPTY','Inserte su respuesta r�pida aqu�');
...
define('_MD_EXCEEDTHREADVIEW','La cantidad de mensajes en este tema exceden el m�ximo permitido para el modo de vista en arbol<br />Por favor c�mbielo a modo de vista plana');


//forumform.inc
define('_MD_PRIVATE','Este es un foro <b>Privado</b>.<br />S�lo los usuarios autorizados pueden enviar y responder mensajes en este foro.');
...
// ERROR messages
define('_MD_ERRORFORUM','ERROR: Foro no seleccionado.');
...
define('_MD_NORIGHTTOEDIT','No tiene permiso para editar en este foro.');
...
define('_MD_ERROREXIST','ERROR: El foro seleccionado no existe. Por favor regrese atr�s e int�ntelo de nuevo.');
define('_MD_ERROROCCURED','Ha ocurrido un error.');
define('_MD_COULDNOTQUERY','Imposible consultar la base de datos.');
define('_MD_FORUMNOEXIST','ERROR: El foro/tema seleccionado no existe. Por favor regrese atr�s e int�ntelo de nuevo.');
define('_MD_USERNOEXIST','ERROR: El usuario no existe.  Por favor regrese atr�s e int�ntelo de nuevo.');
...
define('_MD_TIMEISUP','Ha sobrepasado el tiempo l�mite para poder editar este mensaje.');
define('_MD_TIMEISUPDEL','Ha sobrepasado el tiempo l�mite para poder eliminar este mensaje.');

//reply.php
define('_MD_ON','enviado el'); //Posted on
define('_MD_USERWROTE','%s escribi�:'); // %s is username
define('_MD_RE','Re');

//post.php
define('_MD_EDITNOTALLOWED','No est� autorizado para editar este mensaje.');
define('_MD_EDITEDBY','Editado por');
define('_MD_ANONNOTALLOWED','Los invitados no est�n autorizados a enviar mensajes.<br>Por favor reg�strese.');
define('_MD_THANKSSUBMIT','Gracias por el env�o.');
define('_MD_REPLYPOSTED','Una respuesta a su mensaje ha sido enviada.');
define('_MD_HELLO','Hola %s,');
define('_MD_URRECEIVING','Esta recibiendo este correo debido a que un mensaje que envi� en %s ha sido contestado.'); // %s is your site name
define('_MD_CLICKBELOW','Haga clic en el enlace de abajo para ver el hilo:');
define('_MD_WAITFORAPPROVAL','Gracias. Por favor espere la aprobaci�n del mensaje.');
...
define('_MD_POSTANONLY','Env�o an�nimo');
define('_MD_DOSMILEY','Permitir caritas');
define('_MD_DOXCODE','Permitir c�digo de Xoops');
define('_MD_DOBR','Permitir saltos de l�nea (Es conveniente no activarlo si la opci�n de permitir HTML est� activada)');
define('_MD_DOHTML','Permitir etiquetas HTML');
define('_MD_NEWPOSTNOTIFY', 'Notificarme de nuevos env�os en este hilo');
define('_MD_ATTACHSIG','Incluir firma');
define('_MD_POST','Env�o');
define('_MD_SUBMIT','Enviar');
define('_MD_CANCELPOST','Cancelar env�o');
...
define('_MD_RETURNFORUMINDEX','Regresar al �ndice del foro');
define('_MD_ERROR_BACK','ERROR: Por favor regrese e int�ntelo de nuevo.');
...
define('_MD_TOPICDIGEST','El tema ha sido incluido en la selecci�n.');
define('_MD_TOPICUNDIGEST','El tema ha sido excluido de la selecci�n.');

define('_MD_DELETE','Eliminar');
define('_MD_MOVE','Mover');
define('_MD_MERGE','Combinar');//Fusi�n - Merge
define('_MD_LOCK','Bloquear');
define('_MD_UNLOCK','Desbloquear');
define('_MD_STICKY','Pegar');
define('_MD_UNSTICKY','Despegar');
define('_MD_DIGEST','Incluir en la selecci�n');
define('_MD_UNDIGEST','Excluir de la selecci�n');

define('_MD_DESC_DELETE','Al presionar el bot�n de Eliminar al final de este formulario el tema selecionado y todos sus mensajes relacionados ser�n  <b>permanentemente</b> eliminados.');
define('_MD_DESC_MOVE','Al presionar el bot�n de Mover al final de este formulario el tema selecionado y todos sus mensajes relacionados ser�n movidos al foro seleccionado.');
define('_MD_DESC_MERGE','Al presionar el bot�n de Combinar al final de este formulario el tema selecionado y todos sus mensajes relacionados, ser�n combinados al tema que usted tiene identificado para ser seleccionado.');//Once you press the merge button at the bottom of this form the topic you have selected, and its related posts, will be merged to the topic you have selected.<br /><strong>The destination topic ID must be smaller than current one</strong>.
define('_MD_DESC_LOCK','Al presionar el bot�n de Bloquear al final de este formulario el tema selecionado ser� bloqueado. Puede desbloquearlo cuando quiera si as� lo desea.');
define('_MD_DESC_UNLOCK','Al presionar el bot�n de Desbloquear al final de este formulario el tema selecionado ser� desbloqueado. Puede bloquearlo cuando quiera si as� lo desea.');
define('_MD_DESC_STICKY','Al presionar el bot�n de Pegar al final de este formulario el tema selecionado ser� pegado. Puede despegarlo cuando quiera si as� lo desea.');
define('_MD_DESC_UNSTICKY','Al presionar el bot�n de Despegar al final de este formulario el tema selecionado ser� despagado. Puede pegarlo cuando quiera si as� lo desea.');
define('_MD_DESC_DIGEST','Al presionar el bot�n de Incluir en la selecci�n al final de este formulario el tema selecionado ser� incluido en la selecci�n o compendio de temas. Puede excluirlo cuando quiera si as� lo desea.');
define('_MD_DESC_UNDIGEST','Al presionar el bot�n de Excluir de la selecci�n al final de este formulario el tema selecionado ser� excluido de la selecci�n o compendio de temas. Puede incluirlo cuando quiera si as� lo desea.');

define('_MD_MERGETOPICTO','Tema de la combinaci�n:');//Merge Topic To:
define('_MD_MOVETOPICTO','Mover tema a:');
define('_MD_NOFORUMINDB','Sin foros en la base de datos.');

// delete.php
define('_MD_DELNOTALLOWED','Lo lamento, pero no est� autorizado para eliminar este mensaje.');
define('_MD_AREUSUREDEL','�est� seguro de querer eliminar este mensaje y todos sus relacionados?');
...
define('_MD_ONLINE','En l�nea');
define('_MD_OFFLINE','Ausente');
define('_MD_FLAT', 'Plana');


// online.php
define('_MD_USERS_ONLINE', 'Usuarios en l�nea:');
...
define('_MD_TOTAL_ONLINE','En total hay %d usuarios en l�nea.');
...
// ratethread.php
define("_MD_CANTVOTEOWN", "No puede votar por un env�o realizado por usted mismo.<br />Todos los votos son guardados y revisados.");
define("_MD_VOTEONCE", "Por favor no vote m�s de una vez por el mismo tema.");
...
define("_MD_NOVOTERATE","Todav�a no ha valorado este tema.");
...
define("_MD_POLL_EXPIRATION", "Finalizaci�n");
define("_MD_POLL_EXPIRED", "Finalizada");
define("_MD_POLL_VIEWLOG","Ver bit�cora");
define("_MD_POLL_CREATNEWPOLL", "Crear nueva encuesta");
define("_MD_POLL_POLLDESC", "Descripci�n de la encuesta");
define("_MD_POLL_DISPLAYORDER", "Orden de visionado");
define("_MD_POLL_ALLOWMULTI", "�Permitir selecciones m�ltiples?");
...
define("_MD_POLL_EXPIREDAT", "Finaliz� el %s");
define("_MD_POLL_RESTART", "Restablecer esta encuesta");
define("_MD_POLL_ADDMORE", "Agregar m�s opciones");
define("_MD_POLL_RUSUREDEL", "�Est� seguro de querer eliminar esta encuesta y todos sus comentarios?");
...
define("_MD_POLLMODULE_ERROR","El m�dulo de encuestas de Xoops no est� disponible");
...
define("_MD_MENU_SELECT","Seleccionar");
define("_MD_MENU_HOVER","Hover");
define("_MD_MENU_CLICK","Clic");

define("_MD_WELCOME_SUBJECT","%s ha entrado en el foro");
define("_MD_WELCOME_MESSAGE","Hola, %s es un reci�n llegado.");

define("_MD_VIEWNEWPOSTS","Ver nuevos mensajes");

define("_MD_INVALID_SUBMIT","Env�o inv�lido. Puede que su sesi�n expir�. Por favor reenv�elo o haga una copia del texto del mensaje e ingrese nuevamente para volver a enviarlo si fuese necesario.");

define("_MD_ACCOUNT","Perfil");
define("_MD_NAME","Nombre");
define("_MD_PASSWORD","Contrase�a");
...
define("_MD_TRANSFER_DONE","La acci�n ha sido ejecutada: %s");
...
define("_MD_TYPE_SUSPEND","Suspensi�n");

define("_MD_DBUPDATED", "�Base de datos actualizada con �xito!");

define("_MD_SUSPEND_SUBJECT", "El usuario %s ha sido suspendido por %d d�as");
define("_MD_SUSPEND_TEXT", "El usuario %s ha sido suspendido por %d d�as: <br />[quote]%s[/quote]<br /> <br /> La suspensi�n es v�lida hasta %s");//User %s is suspended for %d days due to:<br />[quote]%s[/quote]<br /><br />The suspension is valid till %s
define("_MD_SUSPEND_UID", "ID de Usuario");
define("_MD_SUSPEND_IP", "IP (Todos los segmentos)");
define("_MD_SUSPEND_DURATION", "Duraci�n de la suspensi�n(d�as)");
define("_MD_SUSPEND_DESC", "Raz�n de la suspensi�n");
...
define("_MD_SUSPEND_MANAGEMENT", "Administrar Moderaci�n");
define("_MD_SUSPEND_NOACCESS", "Se ha suspendido su identificaci�n o IP");
